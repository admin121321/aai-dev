...
<div id="registration" class="form-1 bg-dark-blue">
    ...
    <div id="details" class="basic-1 bg-dark-blue">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset('themes-frontend/images/details-1.jpg') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
	...
	<div id="details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
			...
			<div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="{{ asset('themes-frontend/images/details-lightbox.jpg') }}" alt="alternative">
                </div> <!-- end of image-container -->
			</div> <!-- end of col -->
			<div class="col-lg-4">
                <h3>Goals Setting</h3>
    ...
    <div class="tabs">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset('themes-frontend/images/details-2.jpg') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                    ...
                    <div class="image-container">
                        <div class="video-wrapper">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                                <img class="img-fluid" src="{{ asset('themes-frontend/images/video-preview.jpg') }}" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="resource-container">
                        <img class="img-fluid" src="{{ asset('themes-frontend/images/resources-1.jpg') }}" alt="alternative">
                        <div class="text-container">
                    ...
                    <div class="resource-container">
                        <img class="img-fluid" src="{{ asset('themes-frontend/images/resources-2.jpg') }}" alt="alternative">
                        <div class="text-container">
