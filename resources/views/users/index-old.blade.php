                        ...
                        <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="j_k" name="j_k" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="kategori" name="kategori" class="form-control" onchange="check()" required>
                                    ...
                                    <div class="form-group">
                                        <label>Pangkat : </label>
                                        <select id="pang" name="pang" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label>Tingkat : </label>
                                        <select id="ting" name="ting" class="form-control">
...
<!-- Menampilkan Form Tambahan Jika PNS -->
<script>
 function check() {
	 var data="<div class='form-group row'><div class='col-md-12'><label>Bukti Upload</label><input type='file' class='form-control' name='file_bukti' id='file_bukti'></div></div><div class='form-group row'><div class='col-md-12'><label>Deskripsi Masalah</label><textarea type='text-area' class='form-control' style='height:300px; width:800px;' name='deskripsi' id='deskripsi'></textarea></div></div>";
	 var kosong="<input type='text' class='form-control' name='file_bukti' id='file_bukti' value='0' hidden>";
	 var kosongan="<textarea type='text-area' class='form-control' style='height:300px; width:800px;' name='deskripsi' id='deskripsi' value='0' hidden></textarea></div>";
	 var val = document.getElementById('kategori').value;
	 if(val=='PNS') {
	 	document.getElementById('res').value = document.getElementById('mylocation').innerHTML=data;  
	 } else {
	  document.getElementById('res').value = document.getElementById('mylocation').innerHTML=kosong;
	 }
}
</script>
@endsection